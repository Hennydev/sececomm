...
const Carousel = () => {
  return (
    <HStack w={["95%"]} m={["auto"]} px={["8", "8", "0"]} bg={""} display={"flex"} pb={["8"]} flexDirection={["column", "column", "row"]} alignItems={["center","center"]} justifyContent={["flex-start","center"]} paddingTop={["2", "0", "0", "12"]} >
      ...
      <VStack w={["full", "full", "40%"]} display={"flex"}  pt={["10"]} flexDir={["column"]} alignItems={["center", "center", "flex-start"]} textAlign={"start"} bg={""} >
        <Text paddingY={["0","2","4"]} color={"#808080"}  textAlign={["center", "center", "start","start"]} fontSize={["14pt", "16pt", "24pt"]}>WELCOME TO OUR</Text>
        ...
        <Text w={"80%"} color={"#808080"} marginY={["2","2","2"]}  textAlign={["center", "center", "start","start"]}>Lorem ipsum dolor sit amet consectetur adipisicing elit. Pariatur c maiores. Lorem ipsum dolor sit amet consectetur adipisicing elit. Quia vero quo porro?</Text>
